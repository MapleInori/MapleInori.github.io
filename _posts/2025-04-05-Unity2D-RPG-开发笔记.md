---
layout: article
title: Unity2D-RPG-初次学习笔记
tags: ["Unity","游戏开发"]
key: 20250405
---
## 开发笔记

将里边的各种功能拆成单个东西去写实现和笔记逻辑

基于[《勇士传说》横版卷轴动作类游戏开发教程 | Unity 中文课堂](https://learn.u3d.cn/tutorial/2DAdventure)。
...
比如渐入渐出，可以由自己编写代码控制alpha值和interactable之类的参数，也可以做好动画的渐入和渐出这两帧的alpha值和其他参数之类的，在Animator中让Unity自身控制过度，
